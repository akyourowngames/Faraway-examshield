    ...
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-black text-white font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex relative w-1/2 h-screen flex-col items-center justify-center bg-zinc-950 border-r border-white/5 overflow-hidden">
        ...
        >
          ...
          >
            The next generation of secure examination environments. Protect your academic integrity with enterprise-grade security.
          </motion.p>
        </motion.div>
      </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-11 pr-4 text-white placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all text-sm"
